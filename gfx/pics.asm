...
Samurott-hFrontpic:   INCBIN "gfx/pokemon/samurott-h/front.animated.2bpp.lz"
...
Samurott-hBackpic:   INCBIN "gfx/pokemon/samurott-h/back.2bpp.lz"
...
AceTrainermDPic:     INCBIN "gfx/trainers/ace_trainer_m_d.2bpp.lz"
AceTrainerfDPic:     INCBIN "gfx/trainers/ace_trainer_f_d.2bpp.lz"
