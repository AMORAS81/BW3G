	...
	const LOSTLORNFOREST_SHINY_STONE
...
LostlornForest_MapEvents:
	...
	object_event  7, 15, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, LostlornShinyStone, EVENT_LOSTLORN_SHINY_STONE
	...
	object_event  1,  8, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 3, TrainerSchoolKidMLostlorn, -1
	object_event 15, 22, SPRITE_BREEDER_M, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 2, TrainerPkmnBreederMLostlorn, -1
	object_event 12, 44, SPRITE_BREEDER_F, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 3, TrainerPkmnBreederFLostlorn, -1
