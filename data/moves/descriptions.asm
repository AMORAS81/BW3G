...
FlareBlitzDescription:
	db   "Powerful, but also"
	next "damages the user.@"
...
PsyshockDescription:
	db   "Uses SPCL.ATK on"
	next "target's DEFENSE.@"

QuiverDanceDescription:
	db   "Ups SPCL.ATK, SPCL"
	next "DEF, and SPEED.@"
...
SuckerPunchDescription:
	db   "Fast, fails if foe"
	next "uses STATUS move.@"
...
OverheatDescription:
	db   "Sharply lower user"
	next "SPCL.ATK on use.@"
...
BugBiteDescription:
	db   "Steals opponent's"
	next "held BERRY.@"

PowerGemDescription:
	db   "Attacks with power"
	next "of mystic stones.@"
